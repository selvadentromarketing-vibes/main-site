...
| **Masterplan** | `public/masterplan-map.webp` (1.4 MB, 3840×1528) | `013_260514_MP_AMENIDADES` master file at full resolution | SEO build 2026-09: converted from `masterplan-map.jpg` to WebP; the unused `masterplan.jpg` copy was deleted. If a new master arrives, keep EXACTLY 3840×1528 or re-verify `MasterplanExplorer.tsx` dot positions. |
...
| **Location map** | `public/rutas-acceso.webp` (280 KB, 2206×1265) | Higher-res access-routes master if available | SEO build 2026-09: `LocationSection.tsx` now uses the WebP; the 1.7 MB `rutas-acceso-map.png` duplicate was deleted. |
| **OG share images** | `public/og/og-{home,lots,cenotes}.jpg` (1200×630) | Purpose-shot social crops if design wants them | Generated 2026-09 from hero/Suspiro/cenote assets via `scripts/optimize-images.mjs`. |
