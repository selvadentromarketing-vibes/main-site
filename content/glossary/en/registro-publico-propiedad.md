...
The Registro Público de la Propiedad y del Comercio (RPPC) is the state-level public registry where title, ownership and liens on real estate are recorded in Mexico. Every registered property has a folio real — its unique file, holding the chain of owners and any encumbrance attached to it.
...
Private "cesión de derechos" contracts that never reach a notario or the registry. Without recording there is no practical defense against a double sale: whoever records first prevails, and the second buyer is left with paper and a lawsuit. Pay only against notarized, recordable instruments.

Related: [Escritura](/en/glossary/escritura-publica) · [Ejido](/en/glossary/ejido) · [Fideicomiso](/en/glossary/fideicomiso) · [How to verify a Tulum development is legal](/en/blog/verify-tulum-development-legal-sedetus)
