...
1. **The value declared in your escritura.** That figure becomes your acquisition cost. Under-declaring it to shave the acquisition tax today inflates your taxable gain later — and it is not legal in the first place. Declare the real price.
2. **Facturas for construction and improvements**, issued with your RFC and the property's address. A pool, a wall, a whole house: no factura, no deduction. Cash-paid builders are a discount today and a tax bill tomorrow.
3. **Your closing file.** Notary fees, the ISAI receipt, the appraisal (avalúo), commissions — all of it is deductible under the net-gain route and useless if it is lost.
4. **Trust records if you own through a fideicomiso.** Keep the trust deed and the annuity receipts, along with the rest of your [annual ownership costs](/en/guide/annual-property-costs-mexico) paperwork.
5. **Proof of payment for every transfer**, which is one more reason to move money the way [the payments guide](/en/guide/how-to-pay-for-property-in-mexico) describes: bank to bank, receipt for each one.
...
None of that is exotic, and none of it is something to solve from a website. A cross-border accountant will model your specific case in an hour, and the good ones tell you what to keep before you need it. That conversation is also worth having on the buying side: our own [lawyer-versus-notario guide](/en/guide/lawyer-or-notario-mexico) explains who in a Mexican transaction is actually working for you, and it is not the person calculating the withholding.

Tax is a reason to plan, rarely a reason to decide. If you want the other half of the picture — what the land has done and what carrying it costs — the [appreciation data](/en/tulum-property-appreciation-data) and our [investment page](/en/investment) lay both out, with the same rule as here: our numbers are ours, market ranges are labelled as ranges, and your accountant has the last word.
