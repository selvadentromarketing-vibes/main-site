        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {t.amenities.cards.map((card, i) => (
            <Reveal key={i} delay={i * 120}>
              <TiltCard className="group bg-brand-crema rounded-2xl overflow-hidden border border-brand-verde/10 shadow-sm hover:shadow-2xl transition-shadow duration-500 h-full">
