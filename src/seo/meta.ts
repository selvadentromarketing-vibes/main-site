...
export interface PageMeta {
  ...
  preloadHero?: boolean;
  /**
   * Photographic hero crop for the page band (`/hero/*.webp`, 1600×800).
   * Assigned from HERO_IMAGES below, not written per entry. Absent on the
   * editorial pages, which are typographic by design.
   */
  heroImage?: string;
 ...
 * scripts/optimize-images.mjs into public/hero/.
 */
const HERO_IMAGES: Record<string, string> = {
  lots: '/hero/lots.webp',
  cenotes: '/hero/cenotes.webp',
  'cenote-land': '/hero/cenote-land.webp',
  amenities: '/hero/amenities.webp',
  location: '/hero/location.webp',
  investment: '/hero/investment.webp',
  gated: '/hero/gated.webp',
  eco: '/hero/eco.webp',
  living: '/hero/living.webp',
  developer: '/hero/developer.webp',
  preventa: '/hero/preventa.webp',
};
